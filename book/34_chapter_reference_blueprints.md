...
> **[FIGURE 34.1 — Blueprint selection decision tree: regulatory intensity, zone count, connectivity model, and workload classification as primary selectors]**
...
> **[FIGURE 34.2 — Single-sovereign-zone topology: regions, tiers, networking, and observability data flows within a single zone boundary]**
...
> **[FIGURE 34.3 — Multi-zone, multi-cloud topology: zone boundaries, inter-zone connectivity, federated observability, and the Concert unified topology layer]**
...
> **[FIGURE 34.4 — Air-gapped topology: the self-contained sovereign perimeter, internal service layout, and the controlled import/export boundary]**
...
> **[FIGURE 34.5 — Hybrid sovereign-commercial topology: sovereign zone(s) and commercial tier with boundary management, workload placement policies, and unified operations view]**
