...
> **[FIGURE 26.2 — Sovereign code assistant deployment topologies: data-flow paths for SaaS, on-premises, and hybrid routing, annotating where code context crosses trust boundaries and where prompt/completion data is retained or discarded]**
...
> **[FIGURE 26.5 — Security scanning layers for AI-generated code: IDE-time checks, pre-commit hooks, CI/CD pipeline scans, and post-deployment monitoring, with feedback loops that update the assistant's context to prevent recurrence of flagged patterns]**
...
> **[FIGURE 26.6 — Governance chain for AI-generated code in sovereign operations: from IDE suggestion through developer acceptance, tiered review based on zone classification, pipeline quality gates, and deployment approval, with provenance metadata carried at each stage and zone-based generation policies enforced at the IDE level]**
